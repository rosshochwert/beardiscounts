...
class DiscountsControllerTest < ActionController::TestCase
  ...
  test "should create discount" do
    assert_difference('Discount.count') do
      post :create, discount: { description: @discount.description, location: @discount.location, logo: @discount.logo, name: @discount.name }
    end
  ...
  test "should update discount" do
    put :update, id: @discount, discount: { description: @discount.description, location: @discount.location, logo: @discount.logo, name: @discount.name }
    assert_redirected_to discount_path(assigns(:discount))
  end
